...
sudo docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t https://aks-wappe-ingress-dev.eastus2.cloudapp.azure.com -f openapi -r zap_report.html
# HTML Report
