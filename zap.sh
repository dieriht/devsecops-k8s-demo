...
docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t $applicationURL:$PORT -f openapi -c zap-rules -w report.md -J json_report.json -r zap_report.html
