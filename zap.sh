...
chmod 777 $(pwd)
echo $(id -u):$(id -g)
sudo docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t http://devsecopsr.eastus.cloudapp.azure.com:$PORT -f openapi -r zap_report.html
